...
const Features4 = () => {
	...
	return (
		<section ref={animContainerRef} className="tj-feature-section-three">
			<div className="container">
				<div className="feature-style-5">
					{features.map((feature, idx) => (
						<FeatureCard key={idx} feature={feature} idx={idx} type={3} />
					))}
				</div>
			</div>
		</section>
