	...
	const features = [
		{
			...
			desc: "Hyperscale your customer growth with lead gen, e-commerce and persuasive creative that converts.",
			icon: (
				<svg
					width="81"
					height="81"
		...
		},
		{
			...
			desc: "Immersive creative that attracts and converts. Thumb-stopping ads, landing pages and campaigns that move prospects.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Make data and laser-focused targeting central to your growth. 3rd-party data, reverse-append and real-time analytics.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "We integrate with virtually every platform, system and interface to get you live and start delivering results.",
			icon: (
				<svg
					width="80"
					height="81"
